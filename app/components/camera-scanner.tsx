...
function ToolButton({
  ...
  return (
      ...
      >
        ...
        <span className={cx("text-[11px] font-medium tracking-wide text-zinc-400 text-center line-clamp-2 leading-tight h-8 flex items-start justify-center", dim && "opacity-30")}>
        {label}
      </span>
      </button>
  );
